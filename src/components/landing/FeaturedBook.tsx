...
const FeaturedBook = () => {
  const bookData = {
    ...
    description:
      "Master the art of collaborating with AI coding assistants like GitHub Copilot, Cursor, and Claude. Learn practical techniques for AI-assisted development, from prompt engineering to building complete applications while maintaining quality and control.",
    ...
    isbn: "9789365892932",
    buyLink:
      "https://in.bpbonline.com/products/prompt-driven-development-handbook",
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-center md:items-start">
            ...
            <div className="flex-shrink-0">
              <div className="relative group/cover">
                <div className="absolute inset-0 bg-linear-to-br from-blue-500/40 via-purple-500/40 to-indigo-500/40 rounded-xl blur-xl group-hover/cover:blur-lg transition-all duration-300"></div>
                <div className="relative w-48 h-64 md:w-56 md:h-80 bg-linear-to-br from-blue-500 via-purple-600 to-indigo-600 rounded-xl shadow-2xl overflow-hidden ring-4 ring-theme-border-medium group-hover/cover:ring-theme-accent transition-all duration-300">
                  {bookData.coverImage ? (
                    <img
