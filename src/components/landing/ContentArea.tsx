...
const IconLink = ({
  ...
  return (
    <button
      ...
      className="group flex items-center gap-2 md:gap-3 px-4 md:px-6 py-2 md:py-3 bg-white/5 backdrop-blur-md border border-white/10 rounded-xl hover:bg-white/10 hover:border-white/20 transition-all duration-300 hover:-translate-y-1"
    >
      <FontAwesomeIcon icon={icon} className="text-2xl md:text-4xl text-blue-400 group-hover:text-blue-300 transition-colors" />
      <span className="text-base md:text-lg font-semibold text-gray-100 transition-colors">{linkText}</span>
    </button>
  );
};
...
const Writeup = () => {
  return (
    <div className="space-y-4 md:space-y-8 text-gray-100 leading-relaxed text-base md:text-xl">
      <p>
...
const Social = () => {
  return (
    <div className="flex justify-center gap-6 md:gap-8 py-3">
      <a
        aria-label="GitHub"
        className="text-3xl md:text-5xl text-gray-400 hover:text-white hover:scale-125 transition-all duration-300 hover:drop-shadow-[0_0_20px_rgba(100,100,100,0.5)]"
      ...
      <a
        aria-label="Twitter"
        className="text-3xl md:text-5xl text-gray-400 hover:text-twitter-blue hover:scale-125 transition-all duration-300 hover:drop-shadow-[0_0_20px_rgba(29,161,242,0.6)]"
      ...
      <a
        aria-label="LinkedIn"
        className="text-3xl md:text-5xl text-gray-400 hover:text-linkedin-blue hover:scale-125 transition-all duration-300 hover:drop-shadow-[0_0_20px_rgba(0,119,181,0.6)]"
      ...
      <a
        aria-label="Email"
        className="text-3xl md:text-5xl text-gray-400 hover:text-success hover:scale-125 transition-all duration-300 hover:drop-shadow-[0_0_20px_rgba(34,197,94,0.6)]"
