...
const GitHubCard = ({ url, name }: GitHubCardProps) => {
  ...
  const repoData = githubData[url as keyof typeof githubData] as
  ...
  return (
    ...
    >
      <div className="bg-linear-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-xs border border-white/10 hover:border-blue-500/30 rounded-xl p-4 transition-all duration-300 hover:shadow-[0_0_20px_rgba(59,130,246,0.15)]">
        <div className="flex items-start gap-3">
          {/* GitHub Icon */}
          <div className="w-10 h-10 shrink-0 rounded-lg bg-linear-to-br from-gray-700 to-gray-800 border border-white/10 flex items-center justify-center">
            <svg
