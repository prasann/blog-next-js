...
const About = () => {
    return <div className="content-area bg-white rounded-xl lg:max-w-screen-xl mx-12">
        ...
        <div className="my-4">
            I'm a software architect with experience in building high-scale enterprise
        ...
        <div className="my-4">
            I have done few public talks on various tech topics. Please do check out them <Link href={"/talks"}> here </Link>
        </div>
        <div className="my-4">
